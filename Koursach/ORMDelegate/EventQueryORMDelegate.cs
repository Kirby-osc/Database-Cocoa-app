...
namespace Koursach
{
    public class EventQueryORMDelegate : NSTableViewDelegate
    {
        #region Constants 
        ...
        private EventQueryORMDataSource DataSource;
        #endregion

        #region Constructors
        public EventQueryORMDelegate(EventQueryORMDataSource dataSource)
        {
            // Initialize
